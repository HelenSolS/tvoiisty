 ...
 * - сохранить достаточно деталей для нейросетей (лицо, одежда),
 * - при этом укладываться в лимит тела Vercel (~4.5 MB) для двух картинок в одном запросе.
 */
const STORAGE_MAX_DIM = 960;
